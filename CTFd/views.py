...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p>Monal Tech CTF <a href="https://monaltech.com">Monal Tech</a></p>
            <p>Follow us on social media:</p>
            <a href="https://twitter.com/monaltech"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://facebook.com/monaltech"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://github.com/monaltech"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
